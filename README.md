# A Statically generated app using Next.js and Kontent

Used the boilerplate from kontent.ai which showcases [Next.js](https://nextjs.org)'s Static Generation feature using [Kontent.ai](https://kontent.ai) as the data source.
